                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        @foreach($prod as $obprod)
                            <form method="post" action="{{route('produpdate',$obprod->id)}}"
                                  enctype="multipart/form-data">
                                @csrf

                                <div class="row mb-3">
                                    <label for="name" class="col-md-4 col-form-label text-md-end">Название
                                        товара</label>

                                    <div class="col-md-6">
                                        <input class="form-control" value="{{$obprod->name  }}" id="name" type="text"
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-6">
                                        <input class="form-control" value="{{$obprod->img_url}}" id="img_url"
                                               type="file" name="img_url"
                                               autofocus>
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-6">
                                        <input class="form-control" value="{{$obprod->price}}" id="price" type="text"
                                               name="price" required autofocus>
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <label for="year_of_production" class="col-md-4 col-form-label text-md-end">Дата
                                        выхода
                                        продукта</label>

                                    <div class="col-md-6">
                                        <input class="form-control" value="{{$obprod->year_of_production}}"
                                               id="year_of_production" type="text"
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-6">
                                        <input class="form-control" id="country_of_origin" type="text"
                                               name="country_of_origin" value="{{$obprod->country_of_origin}}" required
                                               autofocus>
                                    </div>
                                </div>
                                @endforeach
                                ...
                                @foreach($prod as $objprod)
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-6">
                                            <input class="form-control" value="{{$objprod->model}}" id="model"
                                                   type="text"
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-6">
                                            <input class="form-control" id="count" value="{{$objprod->count}}"
                                                   type="text"
