...
<head>
    ...
    <link rel="stylesheet" href="/resources/css/app.css" rel="stylesheet">
...
<footer class="text-center text-white">
    <div class="container">
        ...
        <div class="row row-cols-3 justify-content-center my-3">
            ...
            <div class="col-lg-1">
                <a class="m-1"
                   href="https://rutube.ru/video/private/f7e42a4d6c37046a65655ef47a85604c/?p=mtoUJvvD8v8wNOwO9e9ElA"
                   target="_blank" role="button">
                    <svg  style="color: black" sxmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
            ...
            <div class="col-lg-1">
                <a class="m-1" href="https://transxx" target="_blank" role="button">
    ...
    <div class="text-center p-3" style="background-color: rgba(0, 0, 0, 0.13);">
        © 2023
